...
function portfolio_register() {
    $args = array(
		...
		'has_archive' => true,
        'hierarchical' => false,
        'rewrite' => array( 'slug' => 'hemos-hecho'),
        'supports' => array('title', 'editor' , 'excerpt' , 'thumbnail' )
    );
...
register_taxonomy("areas", array('casos' , 'portfolio'), array("hierarchical" => true, "label" => "Áreas de práctica", "singular_label" => "Área", "rewrite" => true));
...
function staff_register() {
    $args = array(
		...
		'has_archive' => true,
        'hierarchical' => false,
        'rewrite' => array( 'slug' => 'quienes-somos/staff'),
        'supports' => array('title', 'editor' , 'excerpt' , 'thumbnail' )
    );
